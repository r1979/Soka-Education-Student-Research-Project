...
if (!function_exists('FoundationPress_scripts')) :
  function FoundationPress_scripts() {
    ...
    wp_enqueue_script( 'dataTables', get_template_directory_uri() . '/js/jquery.dataTables.min.js', array('jquery'), '1.0.0', true );
    wp_enqueue_script( 'handlebars', get_template_directory_uri() . '/js/handlebars.js', array('jquery'), '1.0.0', true );
