...
if(!function_exists('wpv_voting_shortcode')){
    function wpv_voting_shortcode($atts){
        global $post;
        return wpv_voting_get_display_vote($post->ID);
    }
 ...
 * shortcode
 * @since 1.8
 * @usage [wpv-top-voted show="10" nopostmsg="Nothing is voted yet"]
 */
if(!function_exists('wpv_voting_top_voted_shortcode')) {
    function wpv_voting_top_voted_shortcode($atts) {
...
add_shortcode('wpv-top-voted', 'wpv_voting_top_voted_shortcode');
